...
//           {/* Map Location - FIXED STRUCTURE & MOBILE LAYOUT */}
...
//           align-items: center;
//           justify-content: center;
//           background: rgba(255, 255, 255, 0.05); /* Subtle background if image fails */
//         }

//         .logo {
//           width: 100%;
//           height: 100%;
//           object-fit: cover; /* Ensures logo covers area without distortion */
//           display: block;
//         }
...
//         /* Social Links (commented out, but styles kept for consistency) */
//         .social-links {
//           display: flex;
//           gap: 0.8rem;
//           flex-wrap: wrap;
...
//           .brand-header {
//             justify-content: flex-start; /* Align left on mobile for consistency */
//           }
...
//           .map-container {
//             height: 250px; /* Slightly taller on mobile for better view */
//           }
//         }
...
//           .contact-item {
//             flex-direction: row; /* Keep row direction, don't stack on small mobile */
//             text-align: left;
//             gap: 0.75rem;
//           }
...
//           .brand-header {
//             flex-direction: row; /* Keep row, don't stack */
//             text-align: left;
//           }
//         }
    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-grid">
          ...
          {/* Map Location - PERFECT DESKTOP ALIGNMENT */}
          <div className="footer-map">
            <h3>Our Location</h3>
            <div className="map-wrapper">
              <div className="map-container">
      ...
      <style jsx>{`
        ...
        /* PERFECT DESKTOP GRID - 3 EQUAL COLUMNS */
        .footer-grid {
          display: grid;
          grid-template-columns: repeat(3, 1fr);
          gap: 3rem;
