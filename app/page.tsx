            ...
            >
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  width: '100%',
                  height: '100%',
                  background: 'linear-gradient(135deg, rgba(153, 187, 207, 0) 0%, rgba(0, 0, 0, 0.3) 100%)'
                }} />
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <FaBookOpen style={{ fontSize: '1.2rem', color: '#000000ff' }} />
                  <span style={{
                    color: '#000000ff',
                    fontSize: '0.9rem',
                    fontWeight: '500',
